                ...
                <main id="main" class="col-md-9">
                    ...
                    <div class="article event-details">
                        ...
                        <div class="article-img">
                            <img src="{{ Voyager::image($events->image) }}" alt="">
                        </div>
                        <!-- article img -->
                        ...
                        <div class="article-content">
                            <!-- article title -->
                            <h2 class="article-title">{{$events->title}}</h2>
                            <!-- /article title -->
                        ...
                        <ul class="event-meta">
                            ...
                            <li><i class="fa fa-clock-o"></i><strong>Date:</strong>  {{$events->date}} | {{$events->start_time}} - {{$events->end_time}}</li>
                            <li><i class="fa fa-map-marker"></i><strong>Location:</strong> {{$events->location}}</li>
                        <li><i class="fa fa-ticket"></i><strong>Ticket:</strong> ₦ {{$events->price}}</li>
                        </ul>
                        <!-- /event-meta -->
                ...
                <aside id="aside" class="col-md-3">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-causes">
                            <a href="{{ route('events.show', $product->id) }}">
                                <div class="widget-img">
                        ...
                        <div class="container">
                                ...
                                <h2>ARCHIVES</h2>
                                @foreach ($events_by_date as $date => $posts)
